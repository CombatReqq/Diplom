...
namespace PP
{
    ...
    public partial class navEntities : DbContext
    {
        public navEntities()
            : base("name=navEntities")
        {
        }
        ...
        public virtual DbSet<alt_postavok> alt_postavok { get; set; }
        public virtual DbSet<alt_serv> alt_serv { get; set; }
        public virtual DbSet<alt_tov> alt_tov { get; set; }
